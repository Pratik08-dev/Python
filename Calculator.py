...
btnmul.pack(side = BOTTOM)
btndiv = Button(rightFrame,text="*",width=9,height=3,command=lambda:addToText("*"))
btndiv.pack(side = BOTTOM)
btndiff = Button(rightFrame,text="-",width=9,height=3,command=lambda:addToText("-"))
btndiff.pack(side = BOTTOM)
btnplus = Button(rightFrame,text="+",width=9,height=3,command=lambda:addToText("+"))
btnplus.pack(side = BOTTOM)
